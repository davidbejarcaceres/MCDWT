...
cd pycuda-2019.1.2
python3.6 ./configure.py --python-exe=/usr/bin/python3.6 --cuda-root=/usr/local/cuda --cudadrv-lib-dir=/usr/lib/aarch64-linux-gnu --boost-inc-dir=/usr/include --boost-lib-dir=/usr/lib/aarch64-linux-gnu --boost-python-libname=${boost_pyname} --boost-thread-libname=boost_thread --no-use-shipped-boost
make -j4
...
python3.6 -c "import pycuda; print('pycuda version:', pycuda.VERSION)"